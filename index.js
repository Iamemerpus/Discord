...
client.on('ready', async () => {
 ...
 .setAssetsLargeImage('https://files.catbox.moe/p55gq2.gif') //You can put links in tenor or discord and etc.
    .setAssetsLargeText('insert funny text') //Text when you hover the Large image
    .setAssetsSmallImage('https://files.catbox.moe/friryu.gif') //You can put links in tenor or discord and etc.
